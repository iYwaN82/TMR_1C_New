...
def exportDB(r_date: str, base: str, out: str, num: str, dash: bool, xls: bool, xlsx: bool):
	...
	--Требуем. вес/голову
	round(DS_BATCH_LOAD.CALL_WEIGHT/NULLIF(DS_BATCH_delivery.HEAD_COUNT,0),2),
	--Загруженный вес/Голову
	round(DS_BATCH_LOAD.LOADED_WEIGHT/NULLIF(DS_BATCH_delivery.HEAD_COUNT,0),2),
	--Требуем.вес
	...
	--Треб. сух. вес/голову
	round(DS_BATCH_LOAD.CALL_WEIGHT/NULLIF(DS_BATCH_delivery.HEAD_COUNT,0)*DS_BATCH_LOAD.DRYMATTER_PERC / 100,2),
	--Загруженный сух. вес/голову
	round(DS_BATCH_LOAD.LOADED_WEIGHT/NULLIF(DS_BATCH_delivery.HEAD_COUNT,0)*DS_BATCH_LOAD.DRYMATTER_PERC / 100,2),
	--Треб. сух. вес
	round(DS_BATCH_LOAD.CALL_WEIGHT*DS_BATCH_LOAD.DRYMATTER_PERC / 100,2),
	--Загруженный сух. вес
	round(DS_BATCH_LOAD.LOADED_WEIGHT*DS_BATCH_LOAD.DRYMATTER_PERC / 100,2),
	--Розданный сух. вес
	...
	round(DS_BATCH_LOAD.LOADED_WEIGHT*((DS_BATCH_DELIVERY.DELIVERED_WEIGHT-DS_BATCH_DELIVERY.WEIGHBACK_AMOUNT)/NULLIF(DS_BATCH_DELIVERY.CALL_WEIGHT,0))*(DS_BATCH_LOAD.DRYMATTER_PERC / 100)/NULLIF(DS_BATCH_delivery.HEAD_COUNT,0),2),
	--Надои
